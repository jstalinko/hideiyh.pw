...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.dropdown.index','data' => ['placement' => 'bottom-end','teleport' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = BladeUI\Icons\Components\Icon::resolve(['name' => 'heroicon-s-chevron-up'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH /home/shn/workspace/hideiyh-new/vendor/tomatophp/filament-simple-theme/src/../resources/views/sidebar-nav-end.blade.php ENDPATH**/ ?>