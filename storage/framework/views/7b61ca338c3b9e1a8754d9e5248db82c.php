...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['color' => 'gray','size' => 'xs','xOn:click' => 'navigator.clipboard.writeText($refs.phpCode.textContent); copyMessage = \'Copied!\'; setTimeout(() => copyMessage = \'Copy\', 2000)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['color' => 'gray','size' => 'xs','x-on:click' => 'navigator.clipboard.writeText($refs.phpCode.textContent); copyMessage = \'Copied!\'; setTimeout(() => copyMessage = \'Copy\', 2000)']); ?>
...
// Data:
$apikey = "<?php echo e(auth()->user()->apikey); ?>"; // INI ADALAH APIKEY KAMU. 
    ...
    <div x-show="activeTab === 'nodejs'" x-cloak>
        ...
        <div class="relative bg-gray-900 dark:bg-gray-800 rounded-lg p-4 group">
            <div x-data="{ copyMessage: 'Copy' }" class="absolute top-2 right-2">
                <?php if (isset($component)) { $__componentOriginal6330f08526bbb3ce2a0da37da512a11f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6330f08526bbb3ce2a0da37da512a11f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['color' => 'gray','size' => 'xs','xOn:click' => 'navigator.clipboard.writeText($refs.nodeCode.textContent); copyMessage = \'Copied!\'; setTimeout(() => copyMessage = \'Copy\', 2000)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('filament::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'gray','size' => 'xs','x-on:click' => 'navigator.clipboard.writeText($refs.nodeCode.textContent); copyMessage = \'Copied!\'; setTimeout(() => copyMessage = \'Copy\', 2000)']); ?>
                    <span x-text="copyMessage"></span>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal6330f08526bbb3ce2a0da37da512a11f)): ?>
...
// --- Contoh Penggunaan ---
async function main() {
    const apikey = "<?php echo e(auth()->user()->apikey); ?>"; // INI ADALAH APIKEY KAMU.
    const ip = "8.8.8.8";
    ...
    <div x-show="activeTab === 'python'" x-cloak>
        ...
        <div class="relative bg-gray-900 dark:bg-gray-800 rounded-lg p-4 group">
            <div x-data="{ copyMessage: 'Copy' }" class="absolute top-2 right-2">
                <?php if (isset($component)) { $__componentOriginal6330f08526bbb3ce2a0da37da512a11f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6330f08526bbb3ce2a0da37da512a11f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['color' => 'gray','size' => 'xs','xOn:click' => 'navigator.clipboard.writeText($refs.pythonCode.textContent); copyMessage = \'Copied!\'; setTimeout(() => copyMessage = \'Copy\', 2000)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('filament::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'gray','size' => 'xs','x-on:click' => 'navigator.clipboard.writeText($refs.pythonCode.textContent); copyMessage = \'Copied!\'; setTimeout(() => copyMessage = \'Copy\', 2000)']); ?>
                    <span x-text="copyMessage"></span>
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal6330f08526bbb3ce2a0da37da512a11f)): ?>
...
</div><?php /**PATH /home/shn/workspace/hideiyh-new/resources/views/filament/modals/php-code-example.blade.php ENDPATH**/ ?>