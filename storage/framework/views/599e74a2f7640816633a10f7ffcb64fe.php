...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'fi-ta-empty-state-icon h-12 w-12 text-success-500 dark:text-success-400']); ?>
...
<?php endif; ?>
            ...
            <p class="fi-ta-empty-state-description text-base text-gray-500 dark:text-gray-400 mt-4 mb-8">
                Your flow <strong><?php echo e($this->record->name); ?></strong> has been successfully created. You can now download
...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginal6330f08526bbb3ce2a0da37da512a11f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6330f08526bbb3ce2a0da37da512a11f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['color' => 'gray','icon' => 'heroicon-o-list-bullet','tag' => 'a','href' => ''.e(\App\Filament\Resources\FlowResource::getUrl('index')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('filament::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'gray','icon' => 'heroicon-o-list-bullet','tag' => 'a','href' => ''.e(\App\Filament\Resources\FlowResource::getUrl('index')).'']); ?>
                    Flow List
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal6330f08526bbb3ce2a0da37da512a11f)): ?>
...
<?php endif; ?>
<?php /**PATH /home/shn/workspace/hideiyh-new/resources/views/filament/resources/flow-resource/pages/success-flow.blade.php ENDPATH**/ ?>